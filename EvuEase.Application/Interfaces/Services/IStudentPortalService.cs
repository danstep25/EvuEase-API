...
public interface IStudentPortalService
{
    ...
    Task ChangePasswordAsync(long studentId, StudentPortalChangePasswordRequest request, CancellationToken cancellationToken = default);
    ...
    Task ResolvePasswordResetRequestAsync(long requestId, StudentPortalPasswordResetResolveRequest request, string? resolvedBy, CancellationToken cancellationToken = default);
